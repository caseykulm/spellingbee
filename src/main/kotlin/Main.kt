fun main() {
    ...
    val beeBoards: SpellingBeeBoard = beeUcsSet.filter { it.uniqueCount == 7 }.toSet()

//    beeBoards.forEach { println(it) }

    // TODO: Generate a mapping of SpellingBeeBoards to a list of all correct words for board.
